...
Boost Subscriptions Promote exclusive benefits and incentives to increase subscription adoption.

Strengthen Customer Loyalty Reward repeat buyers and encourage customers to move into the Loyal segment.

Review Discount Strategy Evaluate discount-heavy products to balance sales growth with profitability.

Improve Product Positioning Highlight highly rated and best-selling products in marketing campaigns.

Use Targeted Marketing Focus campaigns on high-revenue age groups and customers showing stronger purchase engagement.
...
Open:
customer_behaviour_sqlserver_queries.sql
Run the T-SQL queries to reproduce the business analysis.
Step 3 — Power BI
Open:
customer_behaviour_dashboard_2026.pbix
